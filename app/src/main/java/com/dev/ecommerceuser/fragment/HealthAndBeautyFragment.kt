...
import com.dev.ecommerceuser.adapter.HealthAndBeautyListAdapter
...
class HealthAndBeautyFragment : Fragment() {
    ...
    var mView: View?=null
    lateinit var healthAndBeautyListAdapter: HealthAndBeautyListAdapter
    var catNameList=ArrayList<CategoryName>()
    var categoryList=ArrayList<Categories>()
    lateinit var categoryListAdapter: CategoryListAdapter
    var account_types_id:String="4"
    ...
    private fun setUpViews() {
        ...
        mView!!.imgSearch.setColorFilter(
        ...
        mView!!.tv_frag_health_beauty_search.setOnEditorActionListener(object : TextView.OnEditorActionListener{
            override fun onEditorAction(textView: TextView?, actionId: Int, event: KeyEvent?): Boolean {
                if (actionId == EditorInfo.IME_ACTION_DONE){
                    search_keyword = mView!!.tv_frag_health_beauty_search.text.toString().trim()
                    SharedPreferenceUtility.getInstance().hideSoftKeyBoard(requireContext(),  mView!!.tv_frag_health_beauty_search)
        ...
        mView!!.iv_health_n_beauty_loc.setOnClickListener {
            mView!!.iv_health_n_beauty_loc.startAnimation(AlphaAnimation(1f, 0.5f))
        ...
        mView!!.iv_health_n_beauty_filter.setOnClickListener {
            ...
            healthAndBeautyFilterBottomSheetDialogFragment.setFilterClickListenerCallback(object : HealthAndBeautyFilterBottomSheetDialogFragment.OnFilterClick {
                override fun onFilter(queryMap : HashMap<String, String>) {
                    ...
                    this@HealthAndBeautyFragment.queryMap = queryMap
                    getNamesAndCategories(queryMap)
                }
            })
        }
