...
class CmsFragment : Fragment() {
    ...
    private fun setUpViews() {
        ...
        /*requireActivity().about_us_fragment_toolbar.aboutUsFragment_backimg.setOnClickListener {
            requireActivity().about_us_fragment_toolbar.aboutUsFragment_backimg.startAnimation(
                AlphaAnimation(
                    1f,
                    0.5f
                )
            ...
            SharedPreferenceUtility.getInstance().hideSoftKeyBoard(
                requireContext(),
                requireActivity().about_us_fragment_toolbar.aboutUsFragment_backimg
            )
            findNavController().popBackStack()
        }*/
